...
We will discuss prior specification in detail in online chapter \@ref(ch-priors). For the  moment, just for illustration, we choose the values $a=4$ and $b=4$ for the beta prior. Then, our prior for $\theta$ is the following beta PDF:
