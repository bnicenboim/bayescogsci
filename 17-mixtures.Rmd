...
```{stan mixh2stancode, output.var = "mixh2_stan_showcode", code = readLines(mixture_h2_gen),  tidy = TRUE, comment="", eval = TRUE, cache = FALSE, cache.lazy = FALSE}
```

Generate responses from 500 simulated experiments as follows:

```{r mixh2gen, eval = FALSE, eval = !file.exists("dataR/gen_mix_data.RDS"), cache = FALSE}
