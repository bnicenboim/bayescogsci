...
```{r dbeta, fold = TRUE, fig.cap = "(ref:dbeta)", fig.height = 2.2}
...
# b
ppd_stat(rt_pred, stat = meanrt_diff) +
  ggtitle("(b) Prior predictive distribution of differences in RTs")
...
ppc_stat(ls_dots_data_short$rt,
         yrep = rt_pred,
         stat = meanrt_diff) +
  ggtitle("(b) Posterior predictive distribution of differences in RTs")
```
