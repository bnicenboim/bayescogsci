...
```{r histn400, fig.cap="Histogram of the N400 averages for every trial, overlaid is a density plot of a normal distribution.", message=FALSE, fold = TRUE,fig.height = 2 }
...
```{r ppcheckdens, fig.cap ="(ref:ppcheckdens)", fig.height = 2}
...
```{r priorposteriordiscrepancy,fig.height=11,fig.cap="(ref:priorposteriordiscrepancy)", fig.height = 2}
