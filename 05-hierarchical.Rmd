...
As we will see in section \@ref(sec-distrmodel) and in online chapter \@ref(ch-workflow), "maximal" is a misnomer for Bayesian models, since this mostly refers to limitations of the popular frequentist package for fitting models, `lme4`.
