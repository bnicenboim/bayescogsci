...
```{r load-08, echo = FALSE, message = FALSE, results ="hide", warning = FALSE}
knitr::purl("08-introstan.Rmd")
source("08-introstan.R")
```

## What does `target` do? {#app-target}
...
## Explicitly incrementing the log probability function \index{\texttt{target}} (`target`) vs. using the sampling or distribution `~` notation. {#app-tilde}
...
## Matrix, vector, or \index{\texttt{array}} array in Stan? {#app-stancontainers}
...
## Cholesky factorization {#app-cholesky}
