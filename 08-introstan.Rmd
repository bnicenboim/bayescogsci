...
```{r up, fig.cap = "(ref:up)" ,echo = FALSE, warning=FALSE, fig.height = 2.2}
mu <- seq(-40, 40, 1)
sigma <- seq(0.5, 40, 1)
...
In Figure \@ref(fig:cri)(a), we plot the 95% CrI of the parameters of interest.
...
mcmc_intervals(df_fit_recall,
               ...
               prob = .8,
               point_est = "mean") +
  ggtitle("(a) Parameters of interest in log-odds")
...
mcmc_intervals(df_fit_recall,
               ...
               point_est = "mean") +
  xlab("Change in accuracy") +
  ggtitle("(b) Effects on the average accuracy")

```

The plot in Figure \@ref(fig:cri-vaccdet)(b) shows that our model is estimating that by increasing the set size by one unit, the recall accuracy of the single subject is deteriorates by 2%. In contrast, there is hardly any trial effect or interaction between trial and set size.
