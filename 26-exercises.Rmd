...
### In the Grodner and Gibson 2005 data, in question-response accuracies, is there evidence for the claim that sentences with subject relative clauses are easier to comprehend? {#exr:bf-logistic .unlisted}
...
### Bayes factor and bounded parameters using Stan. {#exr:lognstan .unlisted}
...
### Predictive accuracy of the linear and the logarithm effect of cloze probability. {#exr:logcv .unlisted}
...
### Log-normal model {#exr:stroopcv .unlisted}
...
### Log-normal vs  rec-normal model in Stan {#exr:logrec .unlisted}
...
### Modeling multiple categorical responses. {#exr:mult .unlisted}
...
### An alternative MPT to model the picture recognition task. {#exr:mpt-mnm .unlisted}
...
### A simple MPT model that incorporates phonological complexity in the picture recognition task. {#exr:edit-mpt-cat .unlisted}
...
### A more hierarchical MPT. {#exr:mpt .unlisted}
...
### **Advanced**: Multinomial processing trees. {#exr:mpt-adv .unlisted}
...
### Changes in the true point values. {#exr:pcorrect .unlisted}
...
### RTs in schizophrenic patients and control. {#exr:mixhier .unlisted}
...
### **Advanced:** Guessing bias in the model. {#exr:mixbias .unlisted}
...
### Can we recover the true point values of the parameters of a model when dealing with a contaminant distribution? {#exr:recovery .unlisted}
...
### Can the log-normal race model account for fast errors? {#exr:lnracescale .unlisted}
...
### Accounting for response time and choice in the lexical decision task using the log-normal race model. {#exr:lnldt .unlisted}
...
### Develop a plausible informative prior for the difference between object and subject relative clause reading times {#exr:PriorsRCs .unlisted}
...
### Extracting an informative prior from a published paper for a future study {#exr:Priorslocalcoherence .unlisted}
