...
Even with these extremely unrealistic priors, which require us to change the number of iterations,`iter`, and `adapt_delta` and `max_treedepth` default values to achieve convergence, the output of the model is virtually identical to the previous one (see Figure \@ref(fig:postcomp)).
