...
Incidentally, yet another way to add contrasts is to use the `merge` function in `R`. First, define a data frame that represents the main effects and interaction contrasts for the four conditions.
...
Using `merge` can be easier to manage than `ifelse()` commands when working with more complex designs, such as $2\times 2\times 2$ factorial designs.
