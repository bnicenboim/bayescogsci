...
The actually observed outcome (a 0,1 response; reading time, etc.) will be distinguished from the random variable that generated it by using lower case $y$. We can call $y$ an instance of $Y$; every new observed outcome can be different due to random variability.
