...
Here, the terms $dx$ and $dy$ express the fact that we are summing up the volume under the surface.
...
A quick review of the mathematical foundations needed for statistics is available in the short book by @fox2009mathematical, as well as @gill2006essential. @morin2016probability and @blitzstein2014introduction are accessible introductions to probability theory. @RossProb offers a more advanced treatment which discusses random variable theory and illustrates applications of probability theory. Some basic results  about random variables are also discussed in the above-mentioned textbooks (for example, the expectation and variance of sums of random variables); some of these results will be needed in later chapters of the present book.
