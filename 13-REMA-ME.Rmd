...
```{r relmeanVOTvdur, fig.cap = "The relationship between (centered) mean PCU scores and mean reading speed.",  message = FALSE, fold = TRUE}
df_indiv <- df_indiv %>%
...
```{r meplotstanplot, echo=FALSE,message = FALSE,fig.cap = "The posterior distribution of the slope in the measurement error model, modeling the effect of centered mean PCU on mean reading speed.", fig.height = 3}
